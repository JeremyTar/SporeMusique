        ...
        return {
            ...
            allAlbum: [{
                    songs: [{
                            id: 1,
                            title: "Suprise",
                            url: require('../assets/Song/Kübler/Surprise.wav'),
                            play: false
                        },
                        {
                            id: 2,
                            title: "Déni",
                            url: require('../assets/Song/Kübler/Déni.wav'),
                            play: false
                        },
                        {
                            id: 3,
                            title: "Colére",
                            url: require('../assets/Song/Kübler/Colére.wav'),
                            play: false
                        },
                        {
                            id: 4,
                            title: "Négociation",
                            url: require('../assets/Song/Kübler/Négociation.wav'),
                            play: false
                        },
                        {
                            id: 5,
                            title: "Tristesse",
                            url: require('../assets/Song/Kübler/Tristesse.wav'),
                            play: false
                        },
                        {
                            id: 6,
                            title: "Acceptation",
                            url: require('../assets/Song/Kübler/Acceptation.wav'),
                            play: false
                        },
                        {
                            id: 7,
                            title: "Expérimentation",
                            url: require('../assets/Song/Kübler/Expérimentation.wav'),
                            play: false
                        },
                        {
                            id: 8,
                            title: "Décision",
                            url: require('../assets/Song/Kübler/Décision.wav'),
                            play: false
                        },
                        {
                            id: 9,
                            title: "Intégration",
                            url: require('../assets/Song/Kübler/Intégration.wav'),
                            play: false
                        },
                        {
                            id: 10,
                            title: "Recommencer",
                            url: require('../assets/Song/Kübler/Recommencer.wav'),
                            play: false
                        }
                    ],
                    cover: require("../assets/Cover/Kübler.png"),
                    name: "Kübler"
                },
                {
                    songs: [{
